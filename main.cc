...
void PrintHelp()
{
	std::cout << "usage: mCP [-b] [-g] [-m macrofile]" << std::endl;
	std::cout << std::endl;
	std::cout << "Examples:" << std::endl;
	std::cout << "  mCP -b -m myRun.mac  # Run in batch mode with macro and config." << std::endl;
	std::cout << "  mCP -g               # Run in graphical mode."                   << std::endl;
	std::cout << std::endl;
